package com.example.datingapp.videochat
...
import com.example.quickbloxvideocall.*
...
class CallActivity : BaseActivity(), IncomeCallFragmentCallbackListener,
    ...
    QBRTCClientSessionCallbacks, ConversationFragmentCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.datingapp.R.layout.activity_call)
    }
    ...
    private fun checkPermission() {
        ...
        if (isVideoCall && checkPermissions(PERMISSIONS)) {
            if (cam) {
                ...
                showErrorSnackbar(
                    rootView,
                    getString(com.example.datingapp.R.string.error_permission_video),
                    R.string.dlg_allow,
        ...
        runOnUiThread {
            ...
            if (show) {
                ...
                if (connectionView.parent == null) {
                    (this@CallActivity.findViewById<View>(R.id.fragment_container) as ViewGroup).addView(
                        connectionView
                    )
                }
            } else {
                (this@CallActivity.findViewById<View>(R.id.fragment_container) as ViewGroup).removeView(
                    connectionView
                )
            }
        }
